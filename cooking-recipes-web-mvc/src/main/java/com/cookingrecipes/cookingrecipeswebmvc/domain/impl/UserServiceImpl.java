...
public class UserServiceImpl implements UserService {
    ...
    public User findByName(String name) {
        User found = userRepository.findByName(name).orElseThrow(() -> new EntityNotFoundException(String.format("User '%s' not found.", name)));
        found.setPassword("");
        return found;
    }
    ...
    public User findByUsername(String username) {
        User found = userRepository.findByUsername(username).orElseThrow(() -> new EntityNotFoundException(String.format("User '%s' not found.", username)));
        return found;
    }
